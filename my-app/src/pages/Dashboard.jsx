...
//             <p className="text-3xl font-bold text-indigo-600 mt-2">4 sessions</p>
//           </div>
//           <div className="bg-white p-6 rounded-xl shadow-md">
//             <h3 className="text-lg font-medium text-gray-700">Calories Burned</h3>
//             <p className="text-3xl font-bold text-green-600 mt-2">1,850 kcal</p>
//           </div>
//           <div className="bg-white p-6 rounded-xl shadow-md">
//             <h3 className="text-lg font-medium text-gray-700">Total Distance</h3>
//             <p className="text-3xl font-bold text-yellow-600 mt-2">12.5 km</p>
//           </div>
//         </div>
//       </div>
//     </main>
